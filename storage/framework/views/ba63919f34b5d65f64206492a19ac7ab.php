            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('profile')); ?>"><i
                            ...
                            href="<?php echo e(route('logout')); ?>"><i class="far fa-caret-square-left"></i><span>&nbsp;Keluar</span></a></li>
                </ul>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Halo, Admin</h3><a
                            class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="<?php echo e(route('pelanggan')); ?>"><i
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?php echo e(route('update', $transaksi->id_transaksi)); ?>">
                                        <?php echo csrf_field(); ?>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" id="nopol"
                                                        name="nopol" value="<?php echo e($transaksi->nopol); ?>"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            <?php echo e($transaksi->jns_kendaraan == 'Motor' ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            <?php echo e($transaksi->jns_kendaraan == 'Mobil' ? 'checked' : ''); ?>>
                                                        <label class="form-check-label"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="layanan" name="layanan"
                                                        ...
                                                        <?php $__currentLoopData = $layananList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $layanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($layanan->id_layanan); ?>"
                                                                <?php echo e($transaksi->id_layanan == $layanan->id_layanan ? 'selected' : ''); ?>>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="number" id="qty"
                                                        name="qty" value="<?php echo e($transaksi->qty); ?>"
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="shift" name="shift"
                                                        required>
                                                        <option value="1"
                                                            <?php echo e($transaksi->shift == 1 ? 'selected' : ''); ?>>Shift 1
                                                        </option>
                                                        <option value="2"
                                                            <?php echo e($transaksi->shift == 2 ? 'selected' : ''); ?>>Shift 2
                                                        </option>
                                                        <option value="3"
                                                            <?php echo e($transaksi->shift == 3 ? 'selected' : ''); ?>>Shift 3
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="date" id="tanggal"
                                                        name="tanggal" value="<?php echo e($transaksi->tanggal); ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
...
<?php /**PATH C:\laragon\www\sinitro\resources\views/sinitro/aksi/edit.blade.php ENDPATH**/ ?>