                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" value="<?php echo e($transaksi->nopol); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label class="form-label"><strong>Jenis Kendaraan</strong></label>
                                                    <input class="form-control" type="text" value="<?php echo e($transaksi->jns_kendaraan); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label class="form-label"><strong>Jenis Layanan</strong></label>
                                                    <input class="form-control" type="text" value="<?php echo e($transaksi->layanan->jns_layanan); ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" value="<?php echo e($transaksi->qty); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label class="form-label"><strong>Petugas</strong></label>
                                                    <input class="form-control" type="text" value="<?php echo e($transaksi->name); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label class="form-label"><strong>Shift</strong></label>
                                                    <input class="form-control" type="text" value="<?php echo e($transaksi->shift); ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" value="<?php echo e($transaksi->biaya); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label class="form-label"><strong>Tanggal</strong></label>
                                                    <input class="form-control" type="text" value="<?php echo e($transaksi->tanggal); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">Dibuat : <?php echo e($transaksi->created_at); ?></label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">Update : <?php echo e($transaksi->updated_at); ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary btn-sm">
...
</html><?php /**PATH C:\laragon\www\sinitro\resources\views/sinitro/aksi/tampilan.blade.php ENDPATH**/ ?>