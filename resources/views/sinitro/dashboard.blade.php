            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Halo, {{ $user->name }}</h3><a
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span>{{ $totalMotor }}</span></div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span>{{ $totalMobil }}</span></div>
                                        </div>
                                    ...
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="row g-0 align-items-center">
                                                <div class="col-auto">
                                                    <div class="text-dark fw-bold h5 mb-0 me-3"><span>Rp {{ number_format($totalPendapatan, 0, ',', '.') }}</span></div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span>Shift {{ $user->shift }} -
                                                    {{ $user->name }}</span></div>
                                        </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" required="" name="shift">
                                                        <optgroup label="Petugas Shift">
                                                            <option value="{{ $user->id_users }}" selected="">Shift
                                                                {{ $user->shift }}</option>
                                                        </optgroup>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                                <table class="table my-0" id="dataTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="display: none;">{{ $trx->id }}</td> 
                                                            <td>{{ $key + 1 }}</td>
                                                            <td>{{ $trx->nopol }}</td>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-primary btn-sm" role="button" href="{{ route('view',$trx->id_transaksi) }}">
